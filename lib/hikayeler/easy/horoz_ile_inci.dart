...
class HorozIleInci extends StatefulWidget {
  @override
  _HorozIleInciState createState() => _HorozIleInciState();
}

class _HorozIleInciState extends State<HorozIleInci> {
  String lorem =
  "                                        Horoz, kendine yiyecek bir şeyler bulmak için avluda eşinirken bir inciye rastlamış. Değerli bir şey bulduğunu anlamış fakat inci, ne işine yarayacakmış ki. Değerini bilenler için eşsiz bir şeysin. demiş. Fakat benim için tek bir buğday tanesi bile dünyadaki tüm mücevherlerden daha değerlidir."
      .toLowerCase()
      .replaceAll(',', '')
      .replaceAll('.', '');
  int step = 0;
