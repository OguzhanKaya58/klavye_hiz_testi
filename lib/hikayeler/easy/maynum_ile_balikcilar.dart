...
class MaymunIleBalikcilar extends StatefulWidget {

  @override
  _MaymunIleBalikcilarState createState() => _MaymunIleBalikcilarState();
}

class _MaymunIleBalikcilarState extends State<MaymunIleBalikcilar> {
  String lorem =
      "                                        Bir ağacın tepesinde oturan maymun, aşağıda balıkçıların ırmağa ağ attıklarını görmüş. Balıkçılar, işlerini bitirdikten sonra bir kenara çekilip yemek yemeye koyulmuşlar. Maymun, Ben de yaparım bu işi diyerek aşağı inmiş başlamış ağlarla oynamaya. Oynarken de ağa takılmış. Ne etse kurtulamamış. Sonunda, Hak ettim bunu diye bağırmış. Balıkçılığa aklım mi eriyor ki başıma bu işi açtım."
          .toLowerCase()
          .replaceAll(',', '')
          .replaceAll('.', '');
  int step = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: step != 1
          ? AppBar(
        title: Text("Balıkçılar ile Maymun"),
