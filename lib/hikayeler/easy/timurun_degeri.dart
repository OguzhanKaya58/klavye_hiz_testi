...
class TimurunDegeri extends StatefulWidget {
  @override
  _TimurunDegeriState createState() => _TimurunDegeriState();
}

class _TimurunDegeriState extends State<TimurunDegeri> {
  String lorem =
  "                                        Bir gün Nasreddin Hoca, Timurlenk ile birlikte hamama gider. Göbek taşına otururlar. Konuşma sırasında, bir ara, Timurlenk gururlanarak sorar. Hoca, ben köle olsaydım, acaba kaç akçe ederdim. Nasreddin Hoca şöyle bir bakar. Elli akçe, cevabını verir. Timurlenk kızar, sert bir sesle. Hey, insafsız adam. Elli akçe, yalnız belimdeki kuşağın değeridir, der. Hocanın cevabı hazırdır. Ben de zaten ona değer biçmiştim."
      .toLowerCase()
      .replaceAll(',', '')
      .replaceAll('.', '');
  int step = 0;
