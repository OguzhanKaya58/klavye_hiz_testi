...
class DunyaninDengesiBozulur extends StatefulWidget {
  @override
  _DunyaninDengesiBozulurState createState() => _DunyaninDengesiBozulurState();
}

class _DunyaninDengesiBozulurState extends State<DunyaninDengesiBozulur> {
  String lorem =
  "                                        Komşularından birisi, Nasreddin Hocaya. Hoca Efendi, demiş. Şu insanlar ne kadar da garip. Nasreddin Hoca. Neresi garip. diye sormuş. Komşusu Sabah oldu mu, insanların bir bölümü o yana, bir bölümü bu yana gidiyorlar. Neden ola Nasreddin Hoca, gülümseyerek cevap vermiş. Neden olacak. Hepsi bir tarafa gitmeye kalksa, şu küçücük dünyamızın dengesi bozulur da ondan."
      .toLowerCase()
      .replaceAll(',', '')
      .replaceAll('.', '');
  int step = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: step != 1
          ? AppBar(
        title: Text("Dünyanın Dengesi Bozulur"),
