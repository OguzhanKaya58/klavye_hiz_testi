...
class KarincaIleCekirge extends StatefulWidget {
  @override
  _KarincaIleCekirgeState createState() => _KarincaIleCekirgeState();
}

class _KarincaIleCekirgeState extends State<KarincaIleCekirge> {
  String lorem =
  "                                        Çok soğuk bir kış günü, karıncalar, yazın yığdıkları buğday taneciklerini serip kurutmaya başlamışlar. Açlıktan yarı ölü bir çekirge çıkagelmiş, karıncalardan birazcık buğday istemiş. Peki yazın ne yaptın diye sormuş karıncalar. Gece gündüz şarkı söyledim. demiş çekirge. Karıncalar Demek şarkı söyledin diye gülmüşler Yazın şarkı söylediysen kışın da dans edersin, olur biter."
      .toLowerCase()
      .replaceAll(',', '')
      .replaceAll('.', '');
  int step = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: step != 1
          ? AppBar(
        title: Text("Karınca ile Çekirge"),
