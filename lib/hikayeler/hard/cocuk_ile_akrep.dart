...
class CocukIleAkrep extends StatefulWidget {
  @override
  _CocukIleAkrepState createState() => _CocukIleAkrepState();
}

class _CocukIleAkrepState extends State<CocukIleAkrep> {
  String lorem =
  "                                        Çocuğun biri, duvardaki çekirgeleri birer birer yakalıyormuş. Birçok çekirge yakalamış. Derken, bir akrep görmüş. Onu da çekirge zannedip elini uzatmış. Akrep kuyruğunu kaldırmış hemen. Haydi bakalım demiş. Beni de yakalamaya kalk da gör gününü. Sadece beni değil, elindeki bütün çekirgeleri de kaybedersin."
      .toLowerCase()
      .replaceAll(',', '')
      .replaceAll('.', '');
  int step = 0;
