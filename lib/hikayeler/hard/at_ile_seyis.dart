...
class AtIleSeyis extends StatefulWidget {
  @override
  _AtIleSeyisState createState() => _AtIleSeyisState();
}

class _AtIleSeyisState extends State<AtIleSeyis> {
  String lorem =
  "                                        Hırsız seyis, baktığı atın yemini gizlice çalıp satıyormuş. Fakat bir yandan da atı sürekli tımar ediyor, atın güzel görünmesine gayret ediyormuş. Tabi, at, bundan hoşlanmıyormuş. Sonunda dayanamamış. Güzel görünmemi istiyorsan beni daha az tımar et de, daha çok doyur. demiş seyise."
      .toLowerCase()
      .replaceAll(',', '')
      .replaceAll('.', '');
  int step = 0;
